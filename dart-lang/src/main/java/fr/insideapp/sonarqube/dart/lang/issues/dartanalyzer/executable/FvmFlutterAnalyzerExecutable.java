...
class FvmFlutterAnalyzerExecutable extends AnalyzerExecutable {

    protected FvmFlutterAnalyzerExecutable(SensorContext sensorContext, AnalyzerOutput.Mode mode) {
